...
const Empresas = () => {
  ...
  <h2 className="text-4xl font-bold text-center">Busca por la marca de comida de tu Mascota</h2>
  <p className="pt-6 pb-8 text-base max-w-2xl text-center m-auto">
  Aquí encontrarás todas las marcas de concentrado que ofrecemos en Omega Pet Shop Por favor selecciona la marca que come actualmente tu perro, y/o que fue sugerida por el veterinario, para poder visualizar las diferentes presentaciones que tenemos de esta.
  </p>
